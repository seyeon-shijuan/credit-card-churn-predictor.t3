...
![](data/mdfile/01_blue_attrition.png)
...
![](data/mdfile/02_correlation.png)
- **수치형 변수 공선성 제거**
...
![](data/mdfile/03_confusion_matrix.png)
...
|:-:|:-:|
|![](data/mdfile/04_feature_importance.png)|![](data/mdfile/05_kmeans_clustering.png)|
...
#### 4. 타겟 마케팅 대응 전략
![](data/mdfile/06_attrition_likelihood.png)
